...
class Airplane {
 ...
 const brit = new Instructor({
   ...
   catchPhrase:"Jellybeans",
  });
 console.log(brit.demo("python"))
 ...
 class Student extends Lambdasian{
  ...
  console.log(katie.listSubjects())
  console.log(katie.PRAssignment("CSS"))
 ...
 const stu = new ProjectManager({
  name: "Stu",
  gradClassName: "Web43",
  favInstructor: "Brit",
 });
 console.log(stu.standUp("web43_help"))
